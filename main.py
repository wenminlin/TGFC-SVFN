...
parser.add_argument('--model_name', default='KD', help='SVFEND/FANVM/C3D/VGG/Bbox/Vggish/Bert/TextCNN/Comments/TikTec')
parser.add_argument('--mode_eval', default= 'temporal', help='nocv/cv/temporal')
...
parser.add_argument('--epoch_stop', type=int, default=3)
parser.add_argument('--seed', type=int, default=1902)  #4081
